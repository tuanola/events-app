...
<script>
  ...
  export default {
    ...
    props: {
      ...
      placeHolderStart: { type: String, default: 'MM/DD/YY' },
	  placeHolderEnd: { type: String, default: 'MM/DD/YY' }
    },

    data () {
      return {
        moment,
        currentMonth: moment(this.selectedStartDate, this.datesFormat, true).startOf('month') || moment(this.startDate, this.datesFormat, true).startOf('month') || moment().local().startOf('month'),
